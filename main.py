...
html,body{ background:#050505; margin:0; padding:0; }
...
# 🌟 HTML 컴포넌트로 버튼 중앙 배치 및 디자인 적용
components.html("""
<style>
    .btn-wrap { display: flex; justify-content: center; margin-bottom: 50px; }
    .custom-btn {
        ...
        box-shadow: 0 0 20px rgba(123, 44, 255, 0.4), inset 0 0 10px rgba(123, 44, 255, 0.2);
    }
    .custom-btn:hover {
        transform: scale(1.05); color: #fff; border-color: #9B55FF;
        box-shadow: 0 0 35px rgba(155, 85, 255, 0.8);
    }
</style>
<div class="btn-wrap">
    <a href="?nav=request"><button class="custom-btn">🔐 의뢰하기</button></a>
</div>
""", height=120)

# 페이지 이동 처리
if st.query_params.get("nav") == "request":
